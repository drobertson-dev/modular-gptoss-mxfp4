...
# Kernel Profiling with NVIDIA NSight Compute

Instructions for installing and using Nsight Compute to profile and evaluate kernel performance on NVIDIA hardware.
