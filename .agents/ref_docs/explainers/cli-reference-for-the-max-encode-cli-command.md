---
title: "Reference for the MAX encode CLI Command"
description: "Detailed usage and options for the max encode command to generate text embeddings for semantic search and NLP."
---

# Reference for the MAX encode CLI Command

Detailed usage and options for the max encode command to generate text embeddings for semantic search and NLP.
