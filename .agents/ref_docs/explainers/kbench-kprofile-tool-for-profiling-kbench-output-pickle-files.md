---
title: "KProfile: Tool for Profiling KBench Output Pickle Files"
description: "A guide to using kprofile to analyze kbench results and inject optimal tuning parameters into Mojo source files."
---

# KProfile: Tool for Profiling KBench Output Pickle Files

A guide to using kprofile to analyze kbench results and inject optimal tuning parameters into Mojo source files.
