---
title: "Async Memory Operations & Copy Overlap"
description: "Consider this common scenario in GPU programming:"
---

# Async Memory Operations & Copy Overlap
...
- **Async copy primitives**: Launch background DRAMSRAM transfers
...
- **[`copy_dram_to_sram_async()`](https://docs.modular.com/mojo/kernels/layout/layout_tensor/copy_dram_to_sram_async/)**: Launch background DRAMSRAM transfers using dedicated copy engines
...
copy_dram_to_sram_asyncthread_layout  # Launch background transfer
