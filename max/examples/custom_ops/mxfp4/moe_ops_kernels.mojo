    ...
    for row0 in range(row_base, seg_end, row_stride):
        ...
        if USE_VALUE_SWIZZLE and WRITER_MAP == 2:
            for gidx in range(
                ...
                var outv = decode_mxfp4_packbits_u32_to_8xbf16_scaled_e8m0(
                    p, scale_exp
                )
            ...
            for idx in range(
                ...
                if USE_VALUE_SWIZZLE:
                    ...
                    for byte_in_block in range(8):
                        ...
                        var v2 = decode_mxfp4_byte_to_2xbf16_e8m0(packed0[byte_in_block], scale_exp)
                        B_s0[c, r0 + 0] = v2[0]
                        B_s0[c, r0 + 1] = v2[1]
                    ...
                    for byte_in_block in range(8):
                        ...
                        var v2 = decode_mxfp4_byte_to_2xbf16_e8m0(packed1[byte_in_block], scale_exp)
                        B_s0[c, r0 + 0] = v2[0]
                        B_s0[c, r0 + 1] = v2[1]
