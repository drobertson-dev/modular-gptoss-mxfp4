...
fn _decode_mxfp4_unshuffle_value[
    ...
    var f0 = (col_rel >> 3) & 7
    var c0 = col_rel >> 6
    var k_in = ((((c0 * 2 + d0) * 4 + e0) * 8 + f0) * 2 + g0) * 2 + h0
    ...
    var vals = decode_mxfp4_packbits_u32_to_8xbf16_scaled_e8m0(p, scale_exp)
    return vals[off]
...
fn decode_mxfp4_unshuffle_value[
    ...
    return _decode_mxfp4_unshuffle_value[USE_VALUE_SWIZZLE=USE_VALUE_SWIZZLE](
        w_blocks_ptr,
        w_blocks_stride0,
        w_blocks_stride1,
        w_blocks_stride2,
...
fn _unshuffle_k_in(row_rel: Int, col_rel: Int) -> Int:
    ...
    var f0 = (col_rel >> 3) & 7
    var c0 = col_rel >> 6
    return ((((c0 * 2 + d0) * 4 + e0) * 8 + f0) * 2 + g0) * 2 + h0
...
@always_inline
fn compute_kbyte_row0_from_col(row_rel: Int, col_rel: Int, k0_half: Int) -> Int:
...
fn _load_swizzled_pack_u32(
    ...
    var w_u32 = w_blocks_ptr.address_space_cast[AddressSpace.GLOBAL]().bitcast[
        Scalar[U32]
    ]()
