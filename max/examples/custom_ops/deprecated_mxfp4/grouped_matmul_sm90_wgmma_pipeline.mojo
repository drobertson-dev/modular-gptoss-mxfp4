...
fn grouped_matmul_mxfp4_bf16_wgmma_sm90_pipeline[
    ...
    a_tile_layout: Layout = Layout.row_major(BM, BK),
    a_desc_layout: Layout = Layout.row_major(BM, BK),
](
    a_tma_op: TMATensorTile[BF16, a_tile_layout, a_desc_layout],
    P: Int,
    K: Int,
