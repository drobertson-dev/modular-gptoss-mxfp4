...
# Keep kernel-only imports usable even when architecture dependencies drift
# across MAX nightlies. Tests that only need `kernels`/`weight_adapters`
# should not fail during package import.
try:
