...
For examples of how OpenAI Implemented GPT-OSS and other broad planning documents always refer to the `ref-docs` dir.

# NOTE

This repo is a fork of the Modular mono repo, its not connected to any kind of official work, this is something that I want for my own usecase. Do your best to follow their prescribed way of working in this repo, but if you need to disable something that is blocking you and its not something that is core to what we are working on that is ok. But still try and follow best practices and think about where you make a file or where you create a test. when naming something foolow their conventions. Refer to docs if you are unsure and everything will go well.
